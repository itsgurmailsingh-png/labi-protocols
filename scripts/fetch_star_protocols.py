...
RAW_DIR      = pathlib.Path("data/sources/star_protocols/raw")

ESEARCH_URL  = "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi"
EFETCH_URL   = "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi"

JOURNAL_TERM = "STAR Protocols[Journal]"
SOURCE_NAME  = "star_protocols"
...
def main():
    parser = argparse.ArgumentParser(description="Fetch STAR Protocols articles from PMC")
