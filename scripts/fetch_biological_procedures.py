...
RAW_DIR      = pathlib.Path("data/sources/biological_procedures/raw")

ESEARCH_URL  = "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi"
EFETCH_URL   = "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi"

JOURNAL_TERM = "Biological Procedures Online[Journal]"
SOURCE_NAME  = "biological_procedures"
...
def main():
    parser = argparse.ArgumentParser(description="Fetch Biological Procedures Online articles from PMC")
