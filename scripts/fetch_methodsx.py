"""
fetch_methodsx.py
Fetches MethodsX journal articles from PubMed Central (PMC).
CC-BY only (by/4.0 or by/3.0) — NC and ND variants are skipped.

Usage:
    python3 scripts/fetch_methodsx.py
    python3 scripts/fetch_methodsx.py --limit 200 --start 500
"""
...
RAW_DIR      = pathlib.Path("data/sources/methodsx/raw")

ESEARCH_URL  = "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi"
EFETCH_URL   = "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi"

JOURNAL_TERM = "MethodsX[Journal]"
SOURCE_NAME  = "methodsx"

STEP_SECTION_KEYWORDS     = {"step", "procedure", "protocol", "method", "before you begin", "preparation", "analysis", "extraction", "isolation", "purification", "staining", "incubation", "assembly", "cell culture", "setting up"}
MATERIAL_SECTION_KEYWORDS = {"reagent", "material", "equipment"}
...
def main():
    parser = argparse.ArgumentParser(description="Fetch MethodsX articles from PMC")
